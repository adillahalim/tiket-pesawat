...
<body>
    ...
    <div class="p-3 mb-3 col-md-14 bg-dark text-white">
    ...
    <table class="table table-bordered mt-3">
        <thead class="thead-dark">
            <tr>
                ...
                <th scope="col"><button class="btn btn-light"><a href="tampilan.php" class="text-dark">
        ...
        <tbody>
            ...
            <?php foreach ($tiket as $row) : ?>
                <tr>
                    ...
                    <th><a class="text-success" href="edit.php?id=<?= $row["idTiket"]; ?>">Edit</a> |
                        <a class="text-danger" href="hapus.php?id=<?= $row["idTiket"]; ?>" onclick="return confirm('Lanjutkan Hapus?');">Hapus</a></th>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>
        </tbody>
