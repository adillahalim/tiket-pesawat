        ...
        <form class="container mb-5" action="" method="post">
            <div class="row w-50 mx-auto mt-5">
                <div class="p-3 mb-2 bg-secondary text-white col-md-10 ml-5">
                    <h2 class="mt-3"><b>
                            <center>Create Account</center><b></h2>
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="password2" placeholder="Ulangi Password" name="password2" aria-describedby="inputGroupPrepend" required>
                            <div class="invalid-feedback">
                                Please choose a password
                            </div>
                        </div>
